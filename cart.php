...
if(isset($_SESSION["id"])){
	...
	if($count==0){
		...
		$cartTotal = "<div style='font-size:18px; margin-top:12px;' align='right'>Cart Total : Rs ".$cartTotal." INR</div>";
...
<button type="submit" onclick="location.href='payment.html'" style="padding:0px 50px; font-size:120%;">Checkout</button>
</div>
    </div>
   <br />
  </div>
